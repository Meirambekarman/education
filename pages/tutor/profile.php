<div class="slim-mainpanel" style="margin-top: -21px;">
  <div class="container">
    ...
    <div class="row row-sm">
      ...
      <?php
      $q_col_curses = mysql_query("SELECT DISTINCT(g.id_curs) FROM db_groups g, db_users u
                                                             WHERE u.login = '$_SESSION[login_education]'
                                                               AND g.user_id = u.user_id ");
      $r_col_curses = mysql_num_rows($q_col_curses);
      
      
      $q_col_students = mysql_query("SELECT * FROM db_groups g, db_student_curs s, db_users u
      ...
      <div class="col-lg-4 mg-t-20 mg-lg-t-0">
        <div class="card card-connection">
          <div class="row row-xs">
            <div class="col-4 tx-teal"><?=$r_col_curses?></div>
            <div class="col-8"> <h5>Курстар</h5> </div>
          </div>
          <hr>
          <div class="row row-xs">
            <div class="col-4 tx-purple"><?=$r_col_students?></div>
