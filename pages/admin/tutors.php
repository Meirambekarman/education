<div class="slim-mainpanel" style="margin-top: -21px;">
	<div class="container">
		<div class="slim-pageheader">
			...
			<h6 class="slim-pagetitle">Мұғалімдер тізімі</h6>
		</div>
			...
			<div class="manager-right mg-l-0">
				<div class="row">
					...
					<div class="col-md-12 mg-b-15">
						<button class="btn btn-primary" style="width: 100%" href="#add_new_tutor" data-toggle="modal">Жаңа мұғалім қосу</button>

						<div id="add_new_tutor" class="modal fade">
							<div class="modal-dialog modal-lg" role="document">
								<div class="modal-content bd-0 tx-14">
									<div class="modal-header pd-y-20 pd-x-25">
										<h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Жаңа мұғалім қосу</h6>
					...
					if(isset($_GET['del'])){
						...
						if($delete_stud == true) header('Location:./?tutors');

					}

					$query_list_students  = mysql_query("SELECT * FROM db_users WHERE user_type='2' ");
          	  ...
          	  <div class='card-contact'>
          	    ...
          	    <a href='?tutors&del=$result_list_students[user_id]' class='btn btn-danger btn-icon pull-right mg-t-5'><div><i class='far fa-trash-alt'></i></div></a>
          	  </div>
          	</div>";
					}
